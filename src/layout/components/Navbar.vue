  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <el-dropdown class="avatar-container" trigger="click">
        <div class="avatar-wrapper">
          <img src="@/assets/images/avatar.jpg" style="border: 1px solid grey;border-radius: 10px;" class="user-avatar"/>
        ...
        <el-dropdown-menu slot="dropdown" class="user-dropdown">
          ...
          <el-dropdown-item divided @click.native="updatePwd">
            <span style="display: block">密碼修改</span>
          </el-dropdown-item>
    ...
    >
      <div slot="content">
        ...
        >
          <el-form-item prop="oldPassword" label="原密碼">
...
export default {
  ...
  data() {
    return {
      rules: {
        oldPassword: [
          { trigger: 'blur', required: true, message: '原密碼不能空!' }
        ],
        password: [
          { trigger: 'blur', required: true, message: '新密碼不能為空!' }
        ]
      },
      addModel: {
        userId: '',
